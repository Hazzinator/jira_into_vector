...
# isolation_level=None lets database commands execute straight away
...
def create_table(tableName):
	try:
		cursor.execute('''CREATE TABLE ''' + tableName + '''(snapshot_date DATETIME NOT NULL, 
		key VARCHAR(12) PRIMARY KEY, summary VARCHAR(5000) NOT NULL, status VARCHAR(20), 
		assignee VARCHAR(50), priority VARCHAR(20), created DATETIME NOT NULL, 
		hubble_team VARCHAR(100) NOT NULL, last_updated DATETIME NOT NULL)''')
